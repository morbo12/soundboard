...
/// A specialized card that combines match information with live event controls.
/// This follows the composition pattern to keep components focused and reusable.
class LiveMatchCard extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Card(
      ...
      child: Column(
        children: [
          // Basic match information (without the Card wrapper)
          _MatchCardContent(match: match),
          ...
          // Live event controls with consistent styling
          _LiveMatchControls(match: match),
        ],
      ),
    );
  }
...
/// Internal widget containing the match information content without the Card wrapper.
/// This allows us to embed it within the unified LiveMatchCard.
class _MatchCardContent extends ConsumerWidget {
  final IbyMatch match;

  const _MatchCardContent({required this.match});
        ...
        child: Column(
          ...
          children: [
            ...
            Padding(
              ...
              child: Row(
                children: [_buildStatsIndicators(context, ref), const Spacer()],
              ),
            ),
            // Date and Time Row
            Row(
