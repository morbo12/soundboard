...
class JinglesManagerWidget extends ConsumerStatefulWidget {
  const JinglesManagerWidget({super.key});

  @override
  ConsumerState<JinglesManagerWidget> createState() =>
      _JinglesManagerWidgetState();
}
